...
function reducerSummary(stateSummary, action) {
  ...
  switch (action.type) {
    case "addExspansesName":
      return { ...stateSummary, nameSalary: action.nameSalary };
    case "addExspansesValue":
      return { ...stateSummary, salaryValue: action.salaryValue };
    default:
      throw new Error();
  }
}
...
function reducerSummarySalary(stateSalarySummary, action) {
  switch (action.type) {
    case "salarySummary":
      return [...stateSalarySummary, action.ex];
    default:
      throw new Error();
  }
}
...
function reducerSummaryNameValueExpenses(stateExpenses, action) {
  ...
  switch (action.type) {
    case "expensesSummary":
      return [...stateExpenses, action.ex];
    default:
      throw new Error();
  }
}
...
function reducerDate(stateDate, action) {
  ...
  switch (action.type) {
    case "addCurentDate":
      return { ...stateDate, currentDate: action.currentDate };
    case "addLastDate":
      return { ...stateDate, lastDate: action.lastDate };
    default:
      throw new Error();
  }
}
...
function addLoginPassword(stateLogin, action) {
  ...
  switch (action.type) {
    case "addLogin":
      return { ...stateLogin, login: action.login };
    case "addPassword":
      return { ...stateLogin, password: action.password };
  }
}
...
function fetchNbpTopCountReducer(stateTopCount, action) {
  // eslint-disable-next-line default-case
  switch (action.type) {
    case "putNbpTopCountData":
      return { ...stateTopCount, data: action.data };
    default:
      throw new Error();
  }
}
